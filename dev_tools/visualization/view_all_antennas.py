...
def visualize_helix():
    ...
    mesh2 = Mesh(nodes=rotated_nodes, edges=mesh2_unrotated.edges, radii=mesh2_unrotated.radii)
    ...
    combined_mesh = Mesh(nodes=combined_nodes, edges=combined_edges, radii=combined_radii)
    ...
    combined_element = AntennaElement(
        id=uuid4(), name="Bifilar Helix", type="helix", parameters={}, source=bifilar_source
    )
