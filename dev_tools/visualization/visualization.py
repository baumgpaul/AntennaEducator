...
from backend.common.models.geometry import Mesh, AntennaElement
...
def plot_mesh_3d(mesh: Mesh, element: Optional[AntennaElement] = None, 
...
def visualize_mesh(mesh: Mesh, element: Optional[AntennaElement] = None,
                   console: bool = True, plot: bool = False, 
