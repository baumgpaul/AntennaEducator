...
print("  • Blue wireframe showing antenna geometry")
print("  • Red dots at node positions")
print("  • Gap clearly visible at z=0")
print("  • 22 nodes (11 per half)")
print("  • 20 wire segments (10 per half)")
