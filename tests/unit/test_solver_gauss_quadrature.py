...
class TestGaussQuadrature:
    ...
    def test_points_symmetric(self):
        ...
        for n in get_available_orders():
            ...
            assert np.allclose(
                points, -np.flip(points), rtol=1e-6
    ...
    def test_weights_symmetric(self):
        ...
        for n in get_available_orders():
            ...
            assert np.allclose(
                weights, np.flip(weights), rtol=1e-6
