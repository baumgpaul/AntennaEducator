...
class TestLumpedElement:
    ...
    def test_create_resistor(self):
        ...
        resistor = LumpedElement(
            type="resistor", R=50.0, L=0.0, C_inv=0.0, node_start=1, node_end=2, tag="Load resistor"
        )
    ...
    def test_impedance_property(self):
        ...
        rlc = LumpedElement(type="rlc", R=50.0, L=1e-9, C_inv=1e12, node_start=1, node_end=2)
...
class TestEnhancedSource:
    ...
    def test_voltage_source_basic(self):
        ...
        source = Source(type="voltage", amplitude=complex(1.0, 0.0), node_start=0, node_end=1)
...
class TestAntennaElementWithLumpedElements:
    ...
    def test_antenna_element_without_lumped(self):
        ...
        element = AntennaElement(
            ...
            sources=[Source(type="voltage", amplitude=complex(1.0, 0.0), node_start=0, node_end=1)],
        )
    ...
    def test_antenna_element_with_single_lumped(self):
        ...
        element = AntennaElement(
            ...
            lumped_elements=[
                LumpedElement(
                    type="resistor", R=50.0, L=0.0, C_inv=0.0, node_start=5, node_end=6, tag="Load"
                )
            ],
        )
