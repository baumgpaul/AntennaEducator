...
class TestPreprocessorSolverPipeline:
    ...
    def check_services_running(self):
        ...
        services = [("Preprocessor", PREPROCESSOR_URL), ("Solver", SOLVER_URL)]
    ...
    def test_dipole_complete_analysis(self):
        ...
        response = requests.post(
            f"{PREPROCESSOR_URL}{API_PREFIX}/antenna/dipole", json=dipole_request
        )
        ...
        response = requests.post(f"{SOLVER_URL}/api/solve/single", json=solver_request)
    ...
    def test_dipole_frequency_sweep(self):
        ...
        """
        # Generate geometry
        dipole_request = {"length": 1.5, "wire_radius": 0.001, "gap": 0.001, "segments": 10}

        response = requests.post(f"{PREPROCESSOR_URL}/api/antenna/dipole", json=dipole_request)
        ...
        solver_request = {
            ...
            "voltage_sources": [{"node_start": 1, "node_end": 12, "value": 1.0, "impedance": 50.0}],
            "reference_impedance": 50.0,
        }

        response = requests.post(f"{SOLVER_URL}/api/solve/sweep", json=solver_request)
    ...
    def test_monopole_with_ground_plane(self):
        ...
        response = requests.post(f"{PREPROCESSOR_URL}{API_PREFIX}/antenna/rod", json=rod_request)
        assert response.status_code == 200
        geometry = extract_mesh_from_preprocessor_response(response)
        ...
        solver_request = {
            ...
            "radii": geometry["radii"],
            "frequency": 100e6,
            "voltage_sources": [{"node_start": 1, "node_end": 0, "value": 1.0, "impedance": 50.0}],
        }
    ...
    def test_loop_antenna_analysis(self):
        ...
        # Generate loop
        loop_request = {"radius": 0.2, "wire_radius": 0.001, "segments": 20}  # 20cm radius

        response = requests.post(f"{PREPROCESSOR_URL}{API_PREFIX}/antenna/loop", json=loop_request)
        assert response.status_code == 200
        geometry = extract_mesh_from_preprocessor_response(response)
    ...
    def test_error_handling_invalid_geometry(self):
        ...
        response = requests.post(f"{SOLVER_URL}/api/solve/single", json=bad_request)
    ...
    def test_performance_large_antenna(self):
        ...
        solver_request = {
            ...
            "radii": geometry["radii"],
            "frequency": 100e6,
            "voltage_sources": [{"node_start": 1, "node_end": 27, "value": 1.0, "impedance": 50.0}],
        }
    ...
    def test_regression_dipole_impedance(self):
        ...
        response2 = requests.post(f"{SOLVER_URL}/api/solve/single", json=solver_request)
