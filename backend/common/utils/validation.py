...
def validate_vector_3d(vector: Union[List[float], np.ndarray], name: str = "vector") -> np.ndarray:
    """
...
def validate_unit_vector(
    vector: Union[List[float], np.ndarray], name: str = "vector", tolerance: float = 1e-6
) -> np.ndarray:
    """
...
def validate_lumped_element_nodes(
    lumped_elements: List, num_mesh_nodes: int, element_name: str = "antenna"
) -> None:
    """
