...
class DocumentationService:
    ...
    # Only allow known image extensions to prevent abuse via crafted keys.
    ALLOWED_EXTENSIONS = frozenset({".png", ".jpg", ".jpeg", ".gif", ".svg", ".webp"})
    IMAGE_KEY_PATTERN = re.compile(r"^img_[a-f0-9]{12}\.(png|jpe?g|gif|svg|webp)$")
